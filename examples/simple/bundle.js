  ...
  componentRender: function componentRender(props) {
    return _index2.default.node(
      ...
      _index2.default.node(
        ...
        _index2.default.node('div', { 'class': 'dottedline' })
      )
    );
  }
});
...
var Layout = {
  ...
  render: function render() {
    ...
    var ppl = guests.map(function (itm, ii) {
      return _index2.default.node(NameTag, { ex_person: itm });
    });
    return _index2.default.node(
      'div',
      { 'class': 'container' },
...
_index2.default.rootComponent = Layout;
_index2.default.SetState = function () {
  return function (payload) {
    Layout.state = Object.assign({}, Layout.state, payload);
    _index2.default.objectChange(Layout.render());
    console.log(Layout.state);
  };
}();

_index2.default.createComponent(Layout.render(), document.getElementById('root'));
