...
var EX = require("../src/ex.js");
var GraphINTERFACE = require("../graphs/graphs.js");
var GraphOptions = require("../graphs/data_transform.js");
...
var setMetricsClose = function setMetricsClose(achart) {
  return function (metric) {
    return function () {
      var allM = Object.assign({}, achart.metrics);
      var m = allM[metric];
      allM[metric] = !m;
      if (achart.graphed.length === 1 && achart.graphed[0] === metric) {
        return;
      }
      var graphed = Object.keys(allM).reduce(function (ob, met) {
        if (allM[met]) {
          ob.push(met);
        }
        return ob;
...
var setGraph = function setGraph(type, data, events) {
  var theData = GraphOptions[type](events, data);
  return function () {
    GraphINTERFACE[type](theData, "aChart");
  };
};
var AChart = EX.component({
  componentName: 'chart',
  componentRender: function componentRender(props) {
    var ex_app = props.ex_app;
    var metricView = setMetricsClose(ex_app.achart);
    if (ex_app.eventsData) {
      EX.WhenMounted(setGraph('column', ex_app.eventsData, ex_app.achart.graphed));
    }
    return EX.node('div', { class: "col-xs-12" }, EX.node('p', { class: "center-text" }, EX.node('h3', null, "Events by type this Month")), EX.node('p', { class: "center-text disclaimer" }, EX.node('small', null, "The general API has a limit to the number of events accessible, so I only have this month. Sorry!")), EX.node('div', { class: "btn-group list-by-w" }, EX.node('div', { onClick: metricView('WatchEvent'), class: ex_app.achart.metrics.WatchEvent ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "WatchEvent"), EX.node('div', { onClick: metricView('PushEvent'), class: ex_app.achart.metrics.PushEvent ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "PushEvent"), EX.node('div', { onClick: metricView('IssuesEvent'), class: ex_app.achart.metrics.IssuesEvent ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "IssuesEvent"), EX.node('div', { onClick: metricView('ForkEvent'), class: ex_app.achart.metrics.ForkEvent ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "ForkEvent"), EX.node('div', { onClick: metricView('PullRequestEvent'), class: ex_app.achart.metrics.PullRequestEvent ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "PullRequestEvent")), EX.node('ul', { class: "graphLegend" }, EX.node('li', null, EX.node('div', { class: "angular" }), "Angular"), EX.node('li', null, EX.node('div', { class: "ember" }), "Ember"), EX.node('li', null, EX.node('div', { class: "vue" }), "Vue"), EX.node('li', null, EX.node('div', { class: "react" }), "React"), EX.node('li', null, EX.node('div', { class: "inferno" }), "Inferno")), EX.node('div', { id: "aChart", class: "chart-contain" }), EX.node('div', { class: "block-button" }, EX.node('div', { onClick: goBackList, class: "big-butt cool-button" }, "Back to List")));
  }
});
module.exports = AChart;

},{"../graphs/data_transform.js":14,"../graphs/graphs.js":15,"../src/ex.js":21}],2:[function(require,module,exports){
"use strict";
...
var setPie = function setPie(frameworkData) {
  var pieData = GraphOptions.pie(frameworkData);
  return function () {
...
var Details = EX.component({
  ...
  componentRender: function componentRender(props) {
    ...
    var g = ex_app.data[ex_app.activefw].general;
    var fwInfo = ex_app.fwinfo[ex_app.activefw];
    ...
    return EX.node('div', { class: "col-xs-12 margin-t" }, EX.node('div', { class: "row" }, EX.node('div', { class: "col-xs-3 col-sm-2" }, EX.node('img', { class: "details-img", src: g.owner.avatar_url })), EX.node('div', { class: "col-xs-3 col-sm-3" }, EX.node('h2', { class: "fw-name" }, ex_framework), EX.node('strong', null, "First Commit"), EX.node('p', null, moment(g.created_at).format('LL'))), EX.node('div', { class: "col-xs-7" }, EX.node('table', { class: "table" }, EX.node('thead', null, EX.node('tr', null, EX.node('th', null, "Subscribers"), EX.node('th', null, "Forks"), EX.node('th', null, "Watching"), EX.node('th', null, "Open Issues"))), EX.node('tbody', null, EX.node('tr', null, EX.node('td', { class: "bold-green" }, " ", g.subscribers_count), EX.node('td', { class: "bold-green" }, g.forks), EX.node('td', { class: "bold-green" }, g.watchers), EX.node('td', { class: "bold-red" }, g.open_issues)))), EX.node('p', null, fwInfo.intro), EX.node('strong', null, "Key Features"), EX.node('p', null, fwInfo.extra))), EX.node('div', { class: showGraphs ? "row" : "row hide-elm" }, EX.node('div', { id: "donutContain", class: "chart-contain donut-chart col-sm-6" }), EX.node('div', { id: "growthRate", class: "chart-contain donut-chart aaa col-sm-6" })), EX.node('div', { class: "block-button" }, EX.node('div', { onClick: goBackList, class: "big-butt cool-button" }, "Back to List")));
  }
});

module.exports = Details;

},{"../graphs/data_transform.js":14,"../graphs/graphs.js":15,"../src/ex.js":21,"moment":25}],3:[function(require,module,exports){
"use strict";

var EX = require("../src/ex.js");
var Capitalize = require("../src/lib/handy_funcs.js").capitalize;
var moment = require('moment');

var infoClick = function infoClick(framework) {
  return function () {
    EX.SetState({
      compDisplay: "details",
      activefw: framework,
...
var DropView = EX.component({
  ...
  componentRender: function componentRender(props) {
    ...
    if (!ex_data) {
      return EX.node('div', null, "No Repo");
    }

    var g = ex_data.general;
    var repoName = Capitalize(g.name);
    var getInfo = infoClick(ex_data.repoName);
    var fsClass = "bold-span";
    ...
    return EX.node('div', { class: "repo-data-stuff" }, EX.node('div', { class: "block-pic-name" }, EX.node('img', { class: "detials-img", src: g.owner.avatar_url }), EX.node('div', { class: "repo-info-block" }, EX.node('h4', { class: "bold-h4" }, ex_data.repoName), EX.node('div', { class: "col-xs-6" }, EX.node('p', null, EX.node('span', { class: "bold-span-title" }, "Created:"), " ", moment(g.created_at, "YYYYMMDD").fromNow()), EX.node('p', null, EX.node('span', { class: "bold-span-title" }, "HomePage:"), " ", EX.node('a', { href: g.homepage }, g.homepage)), EX.node('p', null, EX.node('span', { class: "bold-span-title" }, "File Size:"), EX.node('span', { class: fsClass }, " ", ex_data.stats.fileSize), ex_data.stats.fsx)), EX.node('div', { class: "col-xs-6" }, EX.node('p', null, EX.node('span', { class: "icon-span" }, EX.node('i', { class: "fa fa-star yellow-star", 'aria-hidden': "true" })), " ", g.stargazers_count), EX.node('p', null, EX.node('span', { class: "icon-span" }, EX.node('i', { class: "fa fa-code-fork", 'aria-hidden': "true" })), g.forks), EX.node('p', null, EX.node('span', { class: "icon-span" }, EX.node('i', { class: "fa fa-exclamation-circle", 'aria-hidden': "true" })), g.open_issues)))), EX.node('div', { class: "row center-text" }, EX.node('strong', { onClick: getInfo, class: "more-info" }, "More info on ", ex_data.repoName)));
  }
});
module.exports = DropView;

},{"../src/ex.js":21,"../src/lib/handy_funcs.js":23,"moment":25}],4:[function(require,module,exports){
"use strict";

var EX = require("../src/ex.js");
var GitRepo = require("./gitlist.js");
var DropView = require('./dropview.js');
...
var isFirefox = typeof InstallTrigger !== 'undefined' || mobilecheck();

var draggablePolyfil = function () {
  var hasEvent = {};
    ...
    if (patt.test(navigator.vendor)) {
      ...
      for (var i = 0; i < allLi.length; i++) {
        if (hasEvent[allLi[i].id] === undefined) {
          ...
          allLi[i].addEventListener('dragstart', function (e) {
...
var dzEnter = function dzEnter() {
  EX.SetState({
    dropzoneOver: true
  });
};
var dzLeave = function dzLeave() {
  setTimeout(function () {
    EX.SetState({
      dropzoneOver: false
    });
...
var getAvatar = function getAvatar(data, loaded, app, sortwith) {
  ...
  return Object.keys(app.fwList).map(function (itm) {
    ...
    w.framework = itm;
    return w;
  }).sort(sortBy(sortwith)).map(function (ob, i) {
    var w = data[ob.framework];
    w.stats = ob;
    var ani = 'animation: scaleBig ' + String(0.1 * i) + 's ease-out 0.6s 1 forwards';
...
var FWlist = EX.component({
  ...
  componentRender: function componentRender(props) {
    ...
    var dzClass = ex_app.dropzoneOver ? "col-sm-7 drop-column is-dragover" : "col-sm-7 drop-column";
    var dataDrop = ex_app.dropSee ? ex_app.dropSee : {};
    // EX.WhenMounted(draggablePolyfil);

    return EX.node('div', { class: "list-box" }, EX.node('div', { class: "col-xs-12 col-tabs" }, EX.node('div', { class: "top-headline" }, "Frameworks"), EX.node('div', { class: "btn-group list-by-w" }, EX.node('div', { onClick: sortList('created'), class: ex_app.list.order === 'created' ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "Oldest"), EX.node('div', { onClick: sortList('-created'), class: ex_app.list.order === '-created' ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "Newest"), EX.node('div', { onClick: sortList('-stars'), class: ex_app.list.order === '-stars' ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "Stars"), EX.node('div', { onClick: sortList('-size'), class: ex_app.list.order === '-size' ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "Largest First"), EX.node('div', { onClick: sortList('size'), class: ex_app.list.order === 'size' ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "Smallest First"), EX.node('div', { onClick: sortList('perf'), class: ex_app.list.order === 'perf' ? "btn btn-info-o tab-sets active" : "btn btn-info-o tab-sets" }, "Performance"))), EX.node('div', { class: "col-xs-12" }, EX.node('div', { class: isFirefox ? "hide-elm" : dzClass }, EX.node('div', { class: ex_app.dropSee ? "hide-elm" : "drop-zone" }, EX.node('i', { class: "material-icons" }, "system_update_alt"), EX.node('span', null, "Drop Here")), EX.node('div', { class: ex_app.dropSee !== null ? "framework-info" : "hide-elm" }, DropView({ ex_data: ex_app.dropSee, ex_app: ex_app })), EX.node('div', { id: "coverDropArea", class: ex_app.dropSee === null || ex_app.dragged ? "" : "hide-elm", onDragEnter: dzEnter, onDragExit: dzLeave })), EX.node('div', { class: isFirefox ? "col-sm-12" : "col-sm-5" }, EX.node('ul', { class: "nice-list boxed-list list-column" }, gitRepos))));
  }
});

module.exports = FWlist;

},{"../src/ex.js":21,"./dropview.js":3,"./gitlist.js":5,"sort-by":27}],5:[function(require,module,exports){
"use strict";
...
var draggedRepo = function draggedRepo(repo) {
  return function () {
...
var draggedRepoEnd = function draggedRepoEnd(repo, app, data) {
  return function () {
    if (!app.dropzoneOver) {
      return;
    }
    ...
    var dropSee = app.dropzoneOver ? data : null;
    EX.SetState({
      dragged: null,
      dropzoneOver: false,
      dropSee: dropSee
...
var dragCallBacks = function dragCallBacks(repo, event) {
  if (event === 'drag') {
...
var addMetric = function addMetric(num, compData) {
  return function () {
    var mOn = compData.metricsOn;

    var mOnln = mOn.length;
    var ok = mOn.filter(function (v) {
      return v !== num;
    });
    ...
    var newData = Object.assign({}, compData, {
      metricsOn: ok
    });
...
var makeList = function makeList(metrics, graphData) {
  var mt = graphData.metricsOn;
  return metrics.map(function (met, i) {
    var res = mt[0] === i || mt[1] === i || mt[2] === i;
    var whenClicked = addMetric(i, graphData);
    return EX.node('li', { onClick: whenClicked, class: res ? "metric m-select" : "metric" }, met.m2);
  });
};
var goBackList = function goBackList() {
...
var mapMetrics = function mapMetrics(mList, metrics) {
  return mList.map(function (itm) {
    return metrics[itm].m;
  });
};
var graphCallBack = function graphCallBack(mList, metrics, gType) {
  var graphInfo = GraphOptions[gType](mapMetrics(mList, metrics));
...
var Graph = EX.component({
  componentName: 'graph',
  componentRender: function componentRender(props) {
    var metricList = makeList(props.ex_metrics, props.ex_data);

    EX.WhenMounted(graphCallBack(props.ex_data.metricsOn, props.ex_metrics, props.ex_data.type));
    return EX.node('div', { class: "col-xs-12 graph-part" }, EX.node('p', { class: "has-source" }, EX.node('a', { class: "data-from", href: "http://www.stefankrause.net/wp/", target: "_blank" }, "Data Source")), EX.node('ul', { class: "metricsList" }, metricList), EX.node('div', { id: "chartContainer", class: "chart-contain" }), EX.node('div', { class: "block-button" }, EX.node('div', { onClick: goBackList, class: "big-butt cool-button" }, "Back to List")));
  }
});

module.exports = Graph;

},{"../graphs/data_transform.js":14,"../graphs/graphs.js":15,"../src/ex.js":21}],7:[function(require,module,exports){
"use strict";
...
var AChart = require("./achart.js");
var histData = require("../historicalEvents.js");

histData(function (allData, reducedData) {
...
var displaySwitch = function displaySwitch(place) {
   return function () {
      EX.SetState({
         compDisplay: place
      });
...
var Layout = {
   ...
   render: function render() {
      ...
      var graph = _Layout$state.graph;
      var compDisplay = _Layout$state.compDisplay;


      return EX.node('div', null, EX.node('div', { class: loaded ? "section-opts" : "hide-elm" }, EX.node('span', { onClick: displaySwitch("list"), class: compDisplay === "list" || compDisplay === "details" ? "opts-span opt-on" : "opts-span" }, "List"), EX.node('span', { onClick: displaySwitch("graph"), class: compDisplay === "graph" ? "opts-span opt-on" : "opts-span" }, "Performance"), EX.node('span', { onClick: displaySwitch("achart"), class: compDisplay === "achart" ? "opts-span opt-on" : "opts-span" }, "Compare Events"), EX.node('span', { onClick: displaySwitch("trends"), class: compDisplay === "trends" ? "opts-span opt-on" : "opts-span" }, "Trends")), EX.node('div', { class: loaded ? "hide-elm" : "loader" }, "Getting Data..."), EX.node('div', { class: loaded && compDisplay === "list" ? "ok" : "hide-elm" }, FWlist({ ex_data: data, ex_app: Layout.state, ex_loaded: loaded })), EX.node('div', { class: compDisplay === "details" ? "fadeinto" : "hide-elm" }, Details({ ex_data: details.data, ex_app: Layout.state, ex_framework: details.onview })), EX.node('div', { class: compDisplay === "graph" ? "ok" : "hide-elm" }, Graph({ ex_metrics: graph.metrics, ex_data: graph })), EX.node('div', { class: compDisplay === "achart" ? "ok" : "hide-elm" }, AChart({ ex_app: Layout.state })), EX.node('div', { class: compDisplay === "trends" ? "ok" : "hide-elm" }, Trends()));
   }
};
...
},{"../data.js":10,"../historicalEvents.js":17,"../src/ex.js":21,"./achart.js":1,"./details.js":2,"./fwlist.js":4,"./graph.js":6,"./trends.js":9}],8:[function(require,module,exports){
'use strict';
...
var Trends = EX.component({
  componentName: 'trends',
  componentRender: function componentRender(props) {

    return EX.node('div', { class: "col-xs-12" }, EX.node('p', { class: "center-text paddy" }, EX.node('h1', null, "Need to parse and analyze GitHub archive data. . .  ")), EX.node('div', { class: "block-button" }, EX.node('div', { onClick: goBackList, class: "big-butt cool-button" }, "Back to List")));
  }
});
module.exports = Trends;

},{"../src/ex.js":21}],10:[function(require,module,exports){
'use strict';
...
var AppState = {
   ...
   graph: {
      type: "bar",
      metricsOn: [1, 2],
      metrics: [{ m: "create rows", m2: "create rows", on: false }, { m: "replace all rows", m2: "replace all", on: true }, { m: "partial update", m2: "partial update", on: false }, { m: "select row", m2: "select row", on: true }, { m: "swap rows", m2: "swap rows", on: false }, { m: "remove row", m2: "remove row", on: false }, { m: "create many rows", m2: "create 1000 rows", on: false }, { m: "append rows to large table", m2: "append to table", on: false }, { m: "clear rows", m2: "clear rows", on: true }, { m: "clear rows a 2nd time", m2: "repeat clear rows", on: false }]
   },
   fwList: {
      React: {
...
var frameWorkPrefs = require("../components/perf_data.js");
console.log('frameWorkPrefs', frameWorkPrefs);

var perfKeys = ['React', 'Angular1', 'Angular2', 'Vue', 'Inferno', 'Ember'];
var colorKeys = {
  Angular1: "#1976D2",
  Angular2: "#D81159",
  React: "#00d8ff",
...
var bar = function bar(metrics) {
  return perfKeys.map(function (keyy, ii) {
    var p = frameWorkPrefs[keyy];
    return {
      type: "bar",
      showInLegend: true,
      legendText: keyy,
      color: colorKeys[keyy],
      dataPoints: metrics.map(function (type, ii) {
        return {
          y: p[type].v,
          label: type
        };
...
var column = function column(metrics, eventz) {
  return ['angular', 'ember', 'vue', 'react', 'inferno'].map(function (fw) {
    var cl = eventKeys[fw];
    var fww = fw;
    return {
      color: cl,
      dataPoints: metrics.map(function (met, ii) {
        var x = 5 * ii + 5;
...
var pie = function pie(obb) {
  return Object.keys(obb).map(function (keyy, ii) {
    return {
      y: obb[keyy].length,
      indexLabel: keyy
    };
...
},{"../components/perf_data.js":8}],15:[function(require,module,exports){
"use strict";

var bubble = require("./bubblechart.js");
var bar = require("./bargraph.js");
var column = require("./columngraph.js");
...
},{"./bargraph.js":11,"./bubblechart.js":12,"./columngraph.js":13,"./piegraph.js":16}],16:[function(require,module,exports){
"use strict";

module.exports = function () {
   return function (data) {
      var chart = new CanvasJS.Chart("donutContain", {
         title: {
            text: "Event Types"
         },
         legend: {
...
var getYearMonth = function getYearMonth(dateString) {
  var yearMonth = new Date(Date.parse(dateString));
  return yearMonth.getFullYear() + '_' + (yearMonth.getMonth() + 1);
};

var getReduced = function getReduced(fwData) {
  return Object.keys(fwData).reduce(function (obb, item) {
    obb[item] = fwData[item].reduce(function (ob, itm) {
      var yMkey = getYearMonth(itm.created_at);
      if (!ob[yMkey]) {
        ob[yMkey] = 1;
      } else {
        ob[yMkey] += 1;
...
var getHistData = function getHistData(cb) {
  ...
  var resp = JSON.parse(document.getElementById("histData").innerText);

  if (resp['angular']) {
    var evnts = Object.keys(resp).reduce(function (obj, fw) {
...
},{"./components/layout.js":7,"./src/ex.js":21,"./xhrRequests.js":24}],19:[function(require,module,exports){
'use strict';
...
},{"./lib/eventlist.js":22}],21:[function(require,module,exports){
"use strict";
...
},{"./diffing.js":19,"./events.js":20,"./lib/handy_funcs.js":23}],22:[function(require,module,exports){
"use strict";
